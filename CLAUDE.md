...
When writing or reviewing code, read [agent_docs/code_conventions.md](agent_docs/code_conventions.md) for naming, structure, type safety, import order, loop preferences, and frontend-specific rules.
